...
namespace Source.Scripts.ECS.Groups.BuildingTilemap.Systems
{
    public static class BuildingTilemapLoader
    {
        ...
        private static Dictionary<string, TileBase> CacheAllTiles()
        {
            ...
            else UnityEngine.Debug.LogError($"Tile '{Constants.Resources.TilePaths.Exclude}' not found in Resources.");

            if (empty != null) dict.TryAdd(Constants.Tiles.Empty, empty);
            else UnityEngine.Debug.LogError($"Tile '{Constants.Resources.TilePaths.Empty}' not found in Resources.");
